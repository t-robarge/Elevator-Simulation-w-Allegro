...
ALLEGRO_COLOR arrayAllegroColors[ECGV_NUM_COLORS] =
{
    ...
    al_map_rgb_f(0,0,0),
    al_color_name("cornflowerblue"),
    al_color_name("chocolate"),
...
void ECGraphicViewImp :: DrawFilledRectangle(double x1, double y1, double x2, double y2, ECGVColor color)
{
    al_draw_filled_rectangle(x1, y1, x2, y2, arrayAllegroColors[color]);;
}

void ECGraphicViewImp :: DrawFilledCircle(double xcenter, double ycenter, double radius, ECGVColor color)
{
