...
public:
    ...
    void DrawFilledRectangle(double x1, double y1, double x2, double y2, ECGVColor color=ECGV_BLACK);
    void DrawCircle(int xcenter, int ycenter, double radius, int thickness=3, ECGVColor color=ECGV_BLACK);
    void DrawFilledCircle(double xcenter, double ycenter, double radius, ECGVColor color=ECGV_BLACK);
